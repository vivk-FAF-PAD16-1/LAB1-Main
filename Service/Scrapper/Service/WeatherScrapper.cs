...
public class WeatherScrapper
{
    ...
    public WeatherScrapper(DBConnector dbConnector, string openWeatherApiKey)
    {
    ...
    public (bool, string) FindCurrentWeather(string city)
    {
        ...
        _connection.ConnectionString = _dbConnector.GenerateConnectionString();
    ...
    private void AddWeatherDataToBd(CityData cityData, string weatherData)
    {
        ...
        conn.ConnectionString = _dbConnector.GenerateConnectionString();
